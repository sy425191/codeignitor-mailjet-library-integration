...
/**
 * Mailjet Public API Spark Wrapper
 *
 * @author		Mailjet, TheMallen
...
class Mailjet
{
    ...
    var $_method = null;
    var $_request = null;
    var $_request_post = null;
    var $_response_code = null;
    
    # Constructor function
    public function __construct($config = null)
    {
        # access code igniter and get the api keys if none provided
        if(empty($config))
        {
            $config = config('mailjet');
        }
